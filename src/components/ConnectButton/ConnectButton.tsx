...
import {useBalance} from '../../hook/useTokenContract'
...
const ConnectButton = () => {
  ...
  return (
    <>
      {!account && (
        <button
          className='px-[30px] md:px-[60px] font-bold py-[10px] md:py-[20px] bg-gradient-to-r from-[#D95C6B] to-[#D95C6B] hover:bg-gradient-to-l rounded-tr-full rounded-bl-full hover:rounded-tr-none hover:rounded-bl-none hover:rounded-tl-full hover:rounded-br-full transition-all duration-150'
          onClick={(e) => {
            e.stopPropagation();
            connectWallet();
          }}
