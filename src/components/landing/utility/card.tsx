...
const UtilityCard = ({
  ...
  return (
    <div className='relative w-full h-[400px] sm:h-[360px] md:h-[420px] last:h-[300px] md:last:h-[320px] lg:h-[600px]'>
      <div className='absolute left-1/2 -translate-x-1/2 -top-[60px] lg:-top-[120px] w-[140px] h-[140px] lg:w-[240px] lg:h-[240px] bg-gradient-to-b from-[#396EB8] via-[#396EB8] to-[#396EB8] blur-[44px] rounded-full'></div>

      <div className='absolute pt-[80px] lg:pt-[180px] pb-[20px] lg:pb-[40px] px-[17px] bg-white bg-opacity-[0.05] backdrop-blur-[5px] rounded-[5px] z-10'>
      ...
      <div
        className={`group absolute flex justify-center items-center left-1/2 -translate-x-1/2 -top-[60px] lg:-top-[110px] w-[120px] h-[120px] lg:w-[220px] lg:h-[220px] rounded-full z-20 ${
          index % 10 === 0 ? 'utility-circle-down' : 'utility-circle-up'
        }`}
      >
        {icons[index - 1]}
      </div>
