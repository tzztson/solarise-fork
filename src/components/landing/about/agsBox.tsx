...
const AGSBox = ({ index, toRight }: { index: number; toRight?: boolean }) => {
  ...
  return (
    ...
    >
      {images[index]}
      <div
        className={`absolute top-0 w-[240px] h-[32px] from-[#2A538B] via-[#2A538B] to-[#2A538B] ${
          toRight
      ...
      />
      <div
        className={`absolute top-[15.5px] w-[66px] h-[290px] bg-gradient-to-b from-[#2A538B] via-[#2A538B] to-[#2A538B] ${
